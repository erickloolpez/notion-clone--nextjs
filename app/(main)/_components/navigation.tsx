...
const Navigation = () => {
  ...
  }, [isMobile]); //dw of the warning we know we are working with refs in a way react does not recommend, but this is a controlled component and we are aware of the risks.
